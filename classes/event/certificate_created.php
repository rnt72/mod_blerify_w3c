...
/**
 * Certificate created event for mod_blerify.
 *
 * @package    mod_blerify
...
class certificate_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventcertificatecreated', 'blerify');
    }
    ...
    public function get_description() {
        return "The user with id '$this->relateduserid' was issued a Blerify certificate " .
