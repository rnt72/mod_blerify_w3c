...
/**
 * Wallet claim succeeded event for mod_blerify.
 *
 * @package    mod_blerify
...
class claim_succeeded extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventclaimsucceeded', 'blerify');
    }
    ...
    public function get_description() {
        return "The user with id '$this->relateduserid' successfully claimed a credential via wallet " .
