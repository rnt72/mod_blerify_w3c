...
/**
 * Credential issuance failed event for mod_blerify.
 *
 * @package    mod_blerify
...
class credential_issuance_failed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventcredentialissuancefailed', 'blerify');
    }
    ...
    public function get_description() {
        return "Credential issuance failed for the user with id '$this->relateduserid' " .
