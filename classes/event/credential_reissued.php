...
/**
 * Credential reissued event for mod_blerify.
 *
 * @package    mod_blerify
...
class credential_reissued extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventcredentialreissued', 'blerify');
    }
    ...
    public function get_description() {
        return "A credential was reissued for the user with id '$this->relateduserid' " .
