...
/**
 * Wallet DID linked event for mod_blerify.
 *
 * @package    mod_blerify
...
class did_linked extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventdidlinked', 'blerify');
    }
    ...
    public function get_description() {
        return "A wallet DID was linked for the user with id '$this->relateduserid' " .
