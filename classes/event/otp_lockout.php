...
/**
 * OTP lockout event for mod_blerify.
 *
 * @package    mod_blerify
...
class otp_lockout extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventotplockout', 'blerify');
    }
    ...
    public function get_description() {
        return "The user with id '$this->relateduserid' was locked out after too many failed OTP attempts " .
